  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row justify-between items-start space-y-8 md:space-y-0 md:space-x-8">
        <motion.div
          className="w-full md:w-1/3 p-4 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-lg shadow-lg text-white"
        ...
        >
          ...
          <ul className="list-disc pl-6">
            <li className="text-base flex items-center mb-2">
